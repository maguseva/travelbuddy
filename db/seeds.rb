...
Train.create!(
  ...
  price: 99,
  train_number: 'ICE501',
  dep_city: 'Berlin Hauptbahnhof',
  arr_city: 'Munich Hauptbahnhof',
  category: '1st class',
...
Train.create!(
  ...
  dep_city: 'Munich Hauptbahnhof',
  arr_city: 'Berlin Hauptbahnhof',
  category: '2nd class',
  photo: 'https://res.cloudinary.com/dpk0jilwo/image/upload/v1574787281/bahn_kbjhft.png',
  dep_time: '05:57',
  arr_time: '10:24'
...
Train.create!(
  ...
  arr_city: 'Berlin Hauptbahnhof',
  category: '2nd class',
  photo: 'https://res.cloudinary.com/dpk0jilwo/image/upload/v1574787281/bahn_kbjhft.pngs',
  dep_time: '19:55',
  arr_time: '00:42'
  )
...
(date_start..date_start + days_amount).each_with_index { |start_date, index|
  (index + 1..days_amount).each { |end_date_index|
    Package.create!(
      ...
      end_date: date_start + end_date_index,
      hotel: Hotel.all.sample,
      car: Car.all.sample,
      train_from: Train.where(dep_city: 'Berlin Hauptbahnhof').sample,
      train_to: Train.where(arr_city: 'Berlin Hauptbahnhof').sample,
      dep_city: 'Berlin',
      arr_city: 'Munich')
  }
}
